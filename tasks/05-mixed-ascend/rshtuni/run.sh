...
md5sum output/*.bin
python3 scripts/verify_result.py output/matmul_output.bin output/golden.bin
python3 scripts/verify_result.py output/softmax_output.bin output/golden_softmax.bin
